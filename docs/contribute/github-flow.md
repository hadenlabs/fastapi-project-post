...
<!-- Title: Contributing GithubFlow FastApiProjectPost -->
...
To contribute to fastapi-project-post project on [GitHub](https://github.com/hadenlabs/fastapi-project-post), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/fastapi-project-post/pulls).
...
To follow the instructions in this guide and start contributing to fastapi-project-post project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/fastapi-project-post.git
```

Now your **upstream** points to **devops-toolkit/fastapi-project-post**.
...
git fetch upstream # assuming upstream is hadenlabs/fastapi-project-post
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/fastapi-project-post/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
